insert into category (id, category_name, polish_name, category_description, category_img_url)
values (1, 'BREAKFAST','SNIADANIE','Pierwszy posiłek dnia, najczęściej spożywany w godzinach porannych. W zależności od tradycji narodowej składa się z różnych potraw – od
...
insert into category (id, category_name, polish_name, category_description, category_img_url)
values (2, 'LUNCH', 'LUNCH','Szybki, lekki posiłek spożywany w trakcie krótkiej przerwy obiadowej. Znaczeniowo, odpowiednik polskiej przekąski między śniadaniem a obiadem
(drugie śniadanie), spożywany najczęściej w godzinach 10–13.', 'https://i.ytimg.com/vi/hfehjjsHJaQ/maxresdefault.jpg');
insert into category (id, category_name, polish_name, category_description, category_img_url)
values (3, 'DINNER', 'OBIAD', 'Główny i zarazem najobfitszy posiłek w ciągu dnia, spożywany w Polsce najczęściej między godziną 12 a 16. Tradycyjnie składa się z dwóch dań –
...
insert into category (id, category_name, polish_name, category_description, category_img_url)
values (4, 'SUPPER', 'KOLACJA', 'Ostatni posiłek wieczorny. W Polsce i w innych krajach europejskich kolację je się zazwyczaj w godzinach 18-21.', 'https://s3.przepisy.pl/przepisy3ii/img/variants/1070x0/191511-2.jpg');
insert into category (id, category_name, polish_name, category_description, category_img_url)
values (5, 'DESSERT', 'DESER', 'Potrawa podawana jako osobne słodkie danie na koniec posiłku (obiadu, kolacji lub przyjęcia), ale także na podwieczorek albo podczas
niezobowiązującego spotkania o dowolnej porze dnia.', 'https://i.pinimg.com/originals/17/df/68/17df68b12f9e8c799046c9391f965d0e.jpg');
insert into category (id, category_name, polish_name, category_description, category_img_url)
values (6, 'SOUP', 'ZUPA', 'Płynna lub półpłynna potrawa mająca zazwyczaj postać wywaru powstającego podczas gotowania różnorodnych składników. W tradycji polskiej zupa jest
zwykle pierwszym daniem obiadu.', 'https://s3.przepisy.pl/przepisy3ii/img/variants/767x0/rosol_z_kury170242.jpg');
insert into category (id, category_name, polish_name, category_description, category_img_url)
values (7, 'MAIN', 'DANIE GŁÓWNE', 'Jako dania główne oznaczamy posiłki sycące, spożywane o określonych porach dnia - śniadanie, obiad (lunch) i kolacja czy obiadokolacja.
...
insert into category (id, category_name, polish_name, category_description, category_img_url)
values (8, 'FIT', 'FIT', 'Dania lekkie, nie zawierają w sobie składników uznawanych za tuczące i dostarczające człowiekowi "pustych kalorii". Mają za to dużo chudego mięsa,
...
insert into category (id, category_name, polish_name, category_description, category_img_url)
values (9, 'VEGE', 'WEGE', 'Dieta wykluczająca mięso i ryby, a pozostawiająca nabiał i jaja. Bogata w warzywa strączkowe i owoce. U podstawy piramidy żywieniowej wegan
